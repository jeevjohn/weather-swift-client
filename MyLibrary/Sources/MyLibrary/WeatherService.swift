...
class WeatherServiceImpl: WeatherService {
    let authUrl = "http://localhost:8001/v1/auth/"
    let tempUrl = "http://localhost:8001/v1/weather/"
    let helloUrl = "http://localhost:8001/v1/hello/"
    let parameters = ["username": "jeevan", "password": "jeev"]
